            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4">
              ...
              <div className="space-y-3">
                <div className="relative aspect-square overflow-hidden rounded-2xl border border-gray-100 bg-gray-50">
                  <img src={primaryImage} alt="" aria-hidden="true" className="absolute inset-0 h-full w-full scale-110 object-cover opacity-25 blur-sm" />
                  ...
                  {shopGalleryImages.map((imageUrl, index) => (
                    <div key={`${imageUrl.slice(0, 40)}-${index}`} className="overflow-hidden rounded-xl border border-gray-100 bg-gray-50">
                      <div className="relative aspect-square">
                        <img src={imageUrl} alt="" aria-hidden="true" className="absolute inset-0 h-full w-full scale-110 object-cover opacity-25 blur-sm" />
