      ...
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mb-4 grid grid-cols-2 gap-2 md:hidden">
            <Link
              href="/board/notice"
              className="rounded border-2 border-[var(--portal-blue-banner-border)] bg-[var(--portal-blue-banner)] p-3 text-center text-white shadow-sm transition-colors duration-200 hover:bg-[var(--portal-blue-banner-hover)]"
            >
            ...
            <Link
              ...
              className="rounded border-2 border-gray-300 bg-[#f8f9fa] p-3 text-center text-gray-800 shadow-sm transition-all duration-200 hover:border-gray-400 hover:bg-white"
            >
            ...
            <div className="col-span-2 flex h-[88px] flex-col items-center justify-center rounded border border-gray-200 bg-gray-100 text-gray-400">
              <div className="text-xl mb-1">🎯</div>
              <span className="text-xs font-bold">배너 슬롯</span>
              <span className="text-[10px]">모바일 320×88</span>
            </div>
          </div>
