...
export default function ShopMediaSection({ shopName, primaryImage, galleryImages }: ShopMediaSectionProps) {
  ...
  return (
    <div ref={sectionRef} className="rounded-lg border border-gray-200 bg-white p-4">
