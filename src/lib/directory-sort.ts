...
function shuffleRegularShops<T extends ShopListItem>(shops: T[]): T[] {
  const copy = [...shops];
...
export function sortRegularShops<T extends ShopListItem>(shops: T[], sortType: DirectorySortType): T[] {
  if (sortType === 'popular') {
